...
@section('content')
  ...
  <div class="relative h-[45vh]">
    ...
    <div class="absolute inset-0">
      <img src="{{ asset('images/table1.jpg') }}" alt="Dish Image" class="object-cover w-full h-full opacity-70" />
    </div>
  ...
  <div class="container mx-auto mt-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
    ...
    @forelse ($tables as $table )
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            <img src="{{ asset('storage/' . $table->image_path) }}" alt="dish name" class="w-full h-40 object-cover" />
            <div class="p-4">
    ...
    @empty
        <p class="text-center mb-4">Sorry no tables available</p>
    @endforelse
